...
| `antigravity` | [Google Antigravity](https://antigravity.google) | Pane-scrape state detection; headless planning via `agy -p`; YOLO via `--dangerously-skip-permissions` (agy 1.0.2+). No `ccusage` source, so cost shows blank. |
